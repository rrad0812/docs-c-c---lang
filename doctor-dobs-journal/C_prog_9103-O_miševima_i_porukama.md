...
Ovomesečna kolumna se bavi sa nekoliko različitih oblasti. Tema je programiranje vođeno događajima, a da bih vam pokazao kako to funkcioniše, morao sam da smislim softverski model koji koristi arhitekturu događaja. Da bih to uradio, morao sam da se rešim nečega što bi moglo da ispriča priču u jednoj inkapsuliranoj koloni. Dakle, pored softvera vođenog događajima, naći ćete drajvere za miš, tastaturu i ekran.

Naučićete dve strane arhitekture vođene događajima. Videćete kako funkcionišu menadžeri događaja i poruka, i videćete kako aplikacijski program koristi sistem poruka za upravljanje njegovim izvršavanjem.

U tipičnom modelu vođenom događajima, događaji se dešavaju kada pritisnete taster, udarite mišem ili preduzmete neku drugu spoljašnju radnju koja natera program da uradi nešto. Aplikacioni program koji prati ovu kolonu je jednostavan program za hvatanje ekrana za PC u tekstualnom režimu pod DOS-om. Pokreće se iz DOS komandne linije, ali, sa odgovarajućim drajverom, može biti TSR, što znači da može biti rezidentan u memoriji. Program koristi tastaturu ili miša da opiše pravougaonik na ekranu, koji može da upiše u tekstualnu datoteku. Koristim varijaciju ovog programa za snimanje ekrana za softversku dokumentaciju.
...
Dok pišem ovu kolumnu, slušam „Pacific High“, kompakt disk koji mi je Borland poslao zajedno sa ogromnim kalendarom sa umetničkim delima postavljenim na slike disketa. Na CD-u se nalaze Philippe Kahn, njegove flaute, kompozicije i kolekcija različitih muzičkih stilova i muzičara. Uglavnom je džez, i uglavnom se može slušati, ali s vremena na vreme dopire do tog postkoltrejnovskog kakofoničnog zvuka zbog kojeg moja mačka laje.

Programer za bubanj pominje se u beleškama na CD-u. Nadam se da to nije nova paradigma.

Sledećeg meseca...

Razgovaraćemo o TSR drajveru na jeziku C koji će ovomesečnu grabež ekrana i većinu drugih C programa učiniti rezidentnim TSR programima. Pokušaću da otkrijem neke od tajanstvenih osnova TSR-a.

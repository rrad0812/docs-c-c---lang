...
Ovaj članak sadrži sledeće izvršne datoteke: DFLAT.791 DFLAT3.ARC
...
Dodajte i dodeljivanje nule promenljivoj u funkciji CreateVindov u vindov.c. Ova promenljiva čuva reč atributa prozora kada je prozor minimiziran ili maksimiziran. Procedure minimiziranja i maksimiziranja tada mogu isključiti neke atribute koji su neprikladni u minimiziranom ili maksimalnom prozoru. Procedura vraćanja vraća atributnu reč kada vraća prozor.
...
Kompletan paket izvornog koda za D-Flat nalazi se na CompuServe-u u biblioteci 0 DDJ Foruma i na TelePath-u. Njegovo ime je DFLATn.ARC, gde je n ceo broj koji predstavlja labavo dodeljen broj verzije. Biblioteka je preliminarna verzija paketa, ali ona radi. Zameniću ovu datoteku tokom meseci kako se kod menja. Trenutno se sve kompajlira i radi sa Turbo C 2.0 i Microsoft C 6.0. Postoji makefile koji uslužni programi oba kompajlera prihvataju, a postoji i jedan primer programa, program MEMO-PAD. Ako želite da razgovarate o D-Flat-u sa mnom, moj CompuServe ID je 71101,1262, i svakodnevno pratim DDJ Forum.

Oni koji mogu, Da li...

Moj drugar Obri Sirs radi u NASA-inom centru za svemirske letove Goddart i vodi njihove kompjuterske sobe. Ulazi u sve vrste visokotehnoloških stvari. Jednom mi je pokazao sobu punu vodeno hlađenog glavnog računara. Rekao je da serviser mora da ima licencu vodoinstalatera, kao i da ima sertifikat o behemotu. Obri je učio C. On koristi priručnik za obuku C na glavnom računaru, koji je prepun primera kao što je onaj u Primeru 1. U priručniku se kaže da ova vežba demonstrira ponašanje procene sa leva na desno izraza odvojenog zarezom. Ovaj primer čini više od toga.
...
Obri pokreće ove programe na svakom računaru do kojeg može doći, što je impresivan paket hardvera. Pitao se zašto se prevodioci C za Crai, Sun, IBM 3081, VAKS i PC ne slažu oko vrednosti odštampane za k u drugom printf-u. Neki prikazuju 4, drugi prikazuju 5.

Jezik C nikada nije odredio redosled u kome se procenjuju argumenti poziva funkcije. Drugi argument naredbe printf smanjuje k. Treći argument je h. Ako kompajler procenjuje argumente zdesna nalevo, printf će prikazati 5 jer je to ono što je k bilo pre izjave. Ako kompajler procenjuje sleva nadesno, vrednost će biti 4 jer se k smanjuje u drugom argumentu pre nego što se prosleđuje u trećem.

„Koja vrednost je tačna?“ pita Obri. I jedno i drugo, naravno. šta nije u redu? Primer je pogrešan. Programeri ne bi trebalo da pišu kod kao u ovom primeru. To je solidna demonstracija neprenosivog koda. Pisci takozvanih C priručnika za obuku bi trebalo da znaju bolje.

Programerska kutija za sapun: testiranje na lekove i patentna medicina

Sa nepunih 18 godina, prošao sam poligrafsko testiranje da bih dobio prvi posao. Hteli su da se uvere da ja ni na koji način ne predstavljam pretnju po nacionalni interes. U 1950-im, tinejdžeri nisu bili tako moderni i iskusni kao danas, a ja nisam imao dovoljno grešaka ispod pojasa -- ili preko pojasa, što se toga tiče -- da tresem poligrafskom olovkom ili dražim ispitivača. Položio sam taj test i postao kompjuterski programer. Ali napustio sam sobu za preglede kao promenjena osoba. Nisam siguran da je mašina zaista radila više od svojih mogućnosti da zastraši ispitanika, ali sam ubeđen da su ti ljudi narušili moju privatnost preturajući po mom mozgu.

Nekadašnji poslodavci su takođe insistirali na dobroj negovanju. Ako vam je kosa predugačka, vaš šef bi predložio odlazak u berbernicu. Danas izgleda čudno, ali tako je bilo i niko se nije bunio.

U godinama nakon toga, nacija je primetila rastući problem sa drogom, a ista vrsta histerije koja je poslodavcima dala neregulisan pristup vašim mislima sada im omogućava da zavire i u druge delove vašeg tela. Ove invazije uključuju testove vaših telesnih ekstrakata - testove koje oni sprovode u svrhu odobravanja ili nastavka vašeg zaposlenja. Tokom godina, propustio sam nekoliko izabranih poslova jednostavno zato što se nisam podvrgavao poligrafu i testiranju na droge. Ali nikada nisam izgubio nijednu jer se ne bih ošišao.

Sada su se ta dva uslova za zapošljavanje spojila. Kosu možete nositi kako god želite, ali morate je dati svom šefu. Ne, ne da vaš izvršni direktor nosi medaljon ispod prsluka pored svog hladnog, hladnog srca. Ne iz nekog takvog razloga. Žele tvoju kosu za testiranje na drogu.

Korporacija Kirchman iz Altamonte Springsa, Florida, otpustila je programera koji je odbio da im dozvoli da joj uzmu pramen kose. Anita Nabors je protestovala protiv testa na drogu kose po dva osnova. Prigovorila im je da se petljaju sa njenim izgledom tako što joj odrežu deo frizure, i prigovorila je zato što test kose nije univerzalno prihvaćen kao pouzdana tehnika skrininga na droge. Plašila se da će pogrešan rezultat testa ugroziti njen posao i ugled. Ponudila je da se podvrgne testu krvi ili urina, što je po mom mišljenju podjednako nametljivo, ali kompanija je odgovorila ne i poslala šestogodišnjeg, „uzornog” zaposlenog da se pakuje.

Da li su mislili da se drogirala? Ne, to je bila samo nova politika koju su svi morali da se pridržavaju ili da je budu konzervirani. "Sakriti se" bi bio bolji način da se to izrazi. Zakačite svoj bob ili izgubite posao. Kirchman razvija bankarski softver, i jednog dana su se jednostavno probudili i odlučili da njihovi programi moraju biti bez droga. Sve te banke se osećaju bolje znajući da programeri koji pišu softver samo kažu ne, zar ne?

Anita Nabors je tužila Kirchman. Navijam za nju. Kaže mi da su otkako je otišla odustali od programa skrininga na droge, čak i za novozaposlene. Tako je dobro funkcionisalo. Ali Anita još nije našla posao i nisu ponudili da je vrate na posao. Ako vam treba vrhunski Cobol programer koji uči o računarima i čija su hrabrost i karakter netaknuti kao njena frizura, pošaljite upit DDJ-u i ja ću joj ga proslediti.

Međutim, pre nego što sledite Anitin hrabri primer, imajte na umu da će vas isti podli mentalitet koji polaže pravo na vašu kosu, krv, mokraću i pljuvačku, ako prigovorite, žigosati kao verovatnog narkomana ili nosioca side koji ne želi da bude uhvaćen. Zašto bi vam inače smetalo ako vam čačkaju u sokove? Moraš nešto da kriješ.

Na drugu dasku. Prošle nedelje sam pročitao da AT&T pokušava da primeni patent na softverski algoritam koji koristi Ks-Vindov. AT&T polaže prava na algoritam koji čuva bitmapirane slike u memoriji tako da novi prozor može iskočiti i iskočiti kasnije. Oni to zovu "prodavnica za podršku". Oni obaveštavaju programere Ks-Vindov sistema da postoji naknada za licencu za korišćenje ove tehnologije. Pitam se da li će drugi programi – Vindovs, GEM i NevVave, na primer – koji koriste slične algoritme pasti pred istim mačem? Moglo bi biti. Ali pazite, AT&T. Tvoja oštrica je sa dve oštrice. Ovo će vas koštati. Prelazim na US Sprint. Ne samo da protestujem zbog vašeg korišćenja softverskih patenata, već Marfi Braun izgleda bolje od Denisa Ričija.

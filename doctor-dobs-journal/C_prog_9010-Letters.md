...
S vremena na vreme provodim vreme sustižući pisma čitalaca. U poslednje vreme moje poštansko sanduče sadrži neke zanimljive komentare o sadržaju kolumne i jeziku C. Budući da sam ovog meseca (jula) bio pod teškim pritiskom za novi primerak i kao rezultat dugotrajnog putovanja na džez festival u Engleskoj, mislio sam da ću se izvući i pustiti neke od vas da rade moj posao umesto mene.

Evo onda kolumne „Programiranje na C“ koja je uglavnom pisana čitaocima za ovaj mesec.
...
G. Kolvin je poslao nekoliko izvornih fajlova koji rade ono što on traži. Kod uključuje definicije osnovne klase člana zajedno sa uobičajenim metodama. Zatim implementira oblik nasleđivanja klase tako što definiše CLASS makro koji povezuje nasleđene članove i metode podređene klase sa onima iz baze. Operator ## lepi zajedničke elemente različitih imena struktura u one specifične klase. Nisam koristio pristup gospodina Kolvina, ali sam često mislio da bi takva tehnika mogla biti moguća. Uključio sam tri izvorna fajla, class.h, class.c i test.c kao Listing One, strana 147, Listing dva, strana 148, i Listing Three, strana 148 za vaše uživanje i eksperimentisanje.

Greg Kolvin radi u Information Access Sistems u Englevoodu, Kolorado. Grupa u kojoj radi koristi verziju ovog koda u standardnom kompletu alata za korisnički interfejs.

Autor odgovara

Pregledao sam dve MIDI knjige Jima Congera u julu. Poslao mi je lepo pismo zahvalnosti u kome je ispravio moj utisak o svom pogledu na kompjutere i ljude. Evo, delimično, Džimovog odgovora.

Vaši citati o kompjuterima i MIDI pretećim muzičarima su zapravo iz predgovora koji je napisao moj stručni tehnički urednik, Mark Gavin. Držao sam se pisanja koda i objašnjenja.

Moja vizija buduće uloge kompjutera u muzici je manje maštovita od one koju opisujete u vašoj kolumni. Ne vidim da kompjuteri zamenjuju kompozitore isto kao što mogu da vidim kompjutere koji zamenjuju autore. Kao i muzički programi za obradu teksta, MIDI sekvenceri su učinili zadatak pisanja mnogo efikasnijim i (za mene) zadovoljavajućim. Ostaju autori i kompozitori.

MIDI oprema može zameniti izvođače, ali sa mešovitim rezultatima. Čak i moji najbolji napori na skupoj MIDI postavci su daleko manje izražajni od onih na drvenoj flauti staroj 300 godina. Sintetička muzika izgleda najbolje u pozadini filma, a ne na prednjoj strani bine.

Moj pokojni otac, takođe programer, stalno me je podsticao da isprobam algoritamsku kompoziciju. Ovo bi izgledalo prirodno za nekoga poput mene; dugo obučen i za programiranje i za muziku. Posle nekoliko eksperimenata, odbacio sam sterilne rezultate, nalik besmislenoj poeziji koju su napisali analizatori obrazaca reči. Jednom intelektualno zanimljiv, ali bez emotivnog sadržaja.

Čini se da su granice onoga što računari mogu da urade rezultat ograničenja ugrađenih u ljude. Mi nismo bića logike, već smo bića emocija. Muzika se direktno obraća našim emocijama i ne uspeva kada pokušava da dopre do nas kroz naše svesne misli. Milioni godina uzorkovanja vode nas do osobe koja priča, peva ili nastupa sa instrumentom. Računari će teško ispuniti ovu ulogu.
...
Pogledao sam TopSpeed C u aprilu, a JPI je odgovorio pismom uredniku u avgustu. Zamerio sam TSC-u što vam ne dozvoljava da pozovete funkciju prekida na način na koji to rade Turbo C i Microsoft C. Bez ove mogućnosti, program vođen prekidom ne može uvek da prekida lanac. Ovaj nedostatak sam pomenuo predsedniku JPI u februaru i on se tada složio da to treba otkloniti. Međutim, JPI izveštava u svom pismu da funkcija _chain_intr() pruža način da pozovete funkciju prekida u TSC-u. Nije uvek dovoljno. Ako je dokumentacija ispravna, ova funkcija povezuje – umesto poziva – pozvanu funkciju prekida sa pozivnom funkcijom prekida. Ovaj pristup ima dva nedostatka. Prvo, možete izvršiti funkciju prekida samo unutar druge funkcije prekida. Drugo, izvršena funkcija prekida se vraća na mesto odakle je pozvana funkcija, a ne na samu funkciju koja poziva. Postoje mnoge okolnosti u kojima upravljački program prekida treba direktno da pozove funkciju prekida koja se vraća funkciji koja poziva. TSC to ne dozvoljava, a to ograničenje čini TSC beskorisnim za razvoj mnogih programa vođenih prekidima.

Avast, Maties

Pirati napreduju, a ja skačem iz svog poštanskog sandučeta u kutiju za sapunice. U pismu od Kvee S. Phua iz Viktorije, Australija mi se kaže da je kupio dve moje C knjige i da treba da dobije izvorni kod. Dr Phua kaže da su obe knjige štampane u Aziji od strane TP Publications iz Singapura. Dr Phua je pronašao moje ime u DDJ i napisao mi je ovde. Nikada nisam čuo za TP Publications, kao ni MIS Press, izdavača mojih knjiga. Ali očigledno kada TP pravi ilegalne kopije kompjuterskih knjiga, nedostaje im milost da uključe obrasce za narudžbu disketa. Pretpostavljam da su previše glupi da bi i diskete pokvarili. Bob Vilijams, šef MIS Press-a, kaže mi da su knjižare u Singapuru pune piratskih primeraka knjiga Nortona, Dankana, Šildta i drugih značajnih autora. Neću se sada osećati izostavljeno, jer sam u tako istaknutom društvu. Ali Bob takođe kaže da se tu ništa ne može učiniti. Programeri i autori treba da znaju da su lopovi franšizirali značajan segment svog tržišta - pse skorbuta.
